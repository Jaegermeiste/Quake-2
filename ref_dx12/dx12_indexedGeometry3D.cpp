...
dx12::IndexedGeometry3D::IndexedGeometry3D()
{
	LOG_FUNC();
...
bool dx12::IndexedGeometry3D::CreateBuffers(Vertex3D* vertices, size_t vertexBufferSize, unsigned long* indices, size_t indexBufferSize)
{
	LOG_FUNC();
...
bool dx12::IndexedGeometry3D::UpdateVertexBuffer(std::shared_ptr<CommandList> commandList, Vertex3D* vertices, size_t bufferSize) {
	LOG_FUNC();
...
bool dx12::IndexedGeometry3D::UpdateIndexBuffer(std::shared_ptr<CommandList> commandList, unsigned long* indices, size_t bufferSize) {
	LOG_FUNC();
...
void dx12::IndexedGeometry3D::RenderBuffers(std::shared_ptr<CommandList> commandList) const
{
	LOG_FUNC();
...
void dx12::IndexedGeometry3D::Render(std::shared_ptr<CommandList> commandList)
{
	LOG_FUNC();
...
void dx12::IndexedGeometry3D::Shutdown()
{
	try
	{
		if (m_indexBuffer) {
